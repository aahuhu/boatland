...
set(MSG_I_FLAGS "-Ivrx_gazebo:/home/hedy/autoland/src/vrx_gazebo/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/hedy/autoland/src/vrx_gazebo/msg/Contact.msg" NAME_WE)
add_custom_target(_vrx_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "vrx_gazebo" "/home/hedy/autoland/src/vrx_gazebo/msg/Contact.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/hedy/autoland/src/vrx_gazebo/srv/ColorSequence.srv" NAME_WE)
add_custom_target(_vrx_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "vrx_gazebo" "/home/hedy/autoland/src/vrx_gazebo/srv/ColorSequence.srv" ""
)

get_filename_component(_filename "/home/hedy/autoland/src/vrx_gazebo/msg/Task.msg" NAME_WE)
add_custom_target(_vrx_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "vrx_gazebo" "/home/hedy/autoland/src/vrx_gazebo/msg/Task.msg" ""
)
...
_generate_srv_cpp(vrx_gazebo
  "/home/hedy/autoland/src/vrx_gazebo/srv/ColorSequence.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/vrx_gazebo
)
